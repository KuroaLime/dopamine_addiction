...
public:
	...
	/** 명중 확인 수신(UIFX01) — BP에서 Anim_HitMarker 재생 구현. bKilled면 킬 마커(빨강·1.6배·0.4s) */
	UFUNCTION(BlueprintImplementableEvent, Category = "UI|Feedback")
	void OnHitMarker(bool bKilled);
