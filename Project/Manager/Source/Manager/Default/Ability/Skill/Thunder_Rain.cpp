...
#include "Default/Ability/Skill/Thunder_Rain.h"
...
UThunder_Rain::UThunder_Rain()
{
    ...
    static ConstructorHelpers::FObjectFinder<UNiagaraSystem> FXRef(
        TEXT("/Script/Niagara.NiagaraSystem'/Game/Asset/Vefects/Zap_VFX/VFX/Zap/Particles/NS_Zap_04_Green.NS_Zap_04_Green'")
    );
